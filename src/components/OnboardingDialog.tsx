          ...
          <div className="py-4 space-y-5 min-h-[280px]">
            ...
            {step === 4 && (
              <div className="space-y-3">
                ...
                <p className="text-xs text-muted-foreground">Zyklusdaten-Import ist vorerst nicht nötig – gib einfach deinen letzten Periodenstart und deine Zykluslänge ein. Fravia lernt mit der Zeit.</p>
                <div className="relative">
                  <Button variant="outline" className="w-full justify-start" disabled>
